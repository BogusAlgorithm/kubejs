...
ServerEvents.recipes(event => {
  ...
  brewbeer(Item.of('drinkbeer:mixed_beer', 4, '{BlockEntityTag:{MixedBeer:{beerId:7,spiceList:[I;13,5,6]}}}').toJson(), "minecraft:water_bucket","minecraft:bread", "minecraft:pumpkin")
